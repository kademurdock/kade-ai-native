    ...
    static let all: [HelpSection] = [
        ...
        HelpSection(title: "Described video", entries: [
            ...
            HelpEntry(
                ...
                body: "Choose a video from Files or from Photos, paste a YouTube link, or start from a Library video. A YouTube link you copied in another app fills in by itself when you open the screen. Your iPhone may ask before Kade-AI reads a copied link. To stop the asking, open the Settings app, then Kade-AI, then Paste from Other Apps, and choose Allow. Checking a video is free. A long upload keeps going while Kade-AI is open; if it stops, choose the same video again and it carries on where it stopped."
            ),
            HelpEntry(
                title: "The narration",
