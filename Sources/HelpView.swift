    ...
    static let all: [HelpSection] = [
        ...
        HelpSection(title: "Kade's Clubhouse", entries: [
            ...
            HelpEntry(
                ...
                body: "One music player for the whole room, and everybody holds the remote: anyone can play, pause, skip ahead, jump back, or stop it, and it changes for everyone, like a real living-room stereo. Add a song from your files, or paste a song link: a YouTube or Spotify song, SoundCloud, Bandcamp, or a link to an audio file, up to 15 minutes. Then add it politely with Add it to the queue, or rudely with Cut in and play it now. A song link you copied in another app fills in by itself when you're in a room; iOS asks once whether Kade-AI may paste, and Settings, Kade-AI, Paste from Other Apps, Allow stops it asking. When YouTube is blocking the server, the Clubhouse says so, quietly tries again every three minutes for up to an hour, and tells the room when the song lands; Stop knocking cancels it. If somebody skips your song, hit Back a song and take it back; radio fights are allowed. Your music volume is yours alone: it starts low so talk carries over the music, and the volume slider changes only your ears. Voices always come through at full volume."
            ),
            HelpEntry(
